...
public class Test1Question9 {
	
	public JLabel userLabel;
	public JTextField userText;
	public JLabel s;
	
	public Test1Question9() {
		
		JFrame frame5 = new JFrame();
		JPanel panel5 = new JPanel();
		JLabel label5 = new JLabel("What is the output after the code has run?");
		JLabel label6 = new JLabel(" ");
		JLabel label7 = new JLabel("int q = 19");
		JLabel label8 = new JLabel("int i = 3");
		JLabel label9 = new JLabel("int u = q % i");
		...
		button5.addActionListener(new PlayButtonListener20());
		JButton button6 = new JButton("Next");
		button6.addActionListener(new PlayButtonListener21());
