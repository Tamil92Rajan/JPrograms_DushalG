...
public class Test1Question8 {
	
	public JLabel userLabel;
	public JTextField userText;
	public JLabel s;
	
	public Test1Question8() {
		
		JFrame frame5 = new JFrame();
		JPanel panel5 = new JPanel();
		JLabel label5 = new JLabel("What is the output after the code has run?");
		JLabel label6 = new JLabel(" ");
		JLabel label7 = new JLabel("int s = 35");
		JLabel label8 = new JLabel("int h = 5");
		JLabel label9 = new JLabel("int y = s % h");
		...
		button5.addActionListener(new PlayButtonListener18());
		JButton button6 = new JButton("Next");
		button6.addActionListener(new PlayButtonListener19());
