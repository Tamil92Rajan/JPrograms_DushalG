...
public class Test1Question7 {
	
	public JLabel userLabel;
	public JTextField userText;
	public JLabel s;
	
	public Test1Question7() {
		
		JFrame frame5 = new JFrame();
		JPanel panel5 = new JPanel();
		JLabel label5 = new JLabel("What is the output after the code has run?");
		JLabel label6 = new JLabel(" ");
		JLabel label7 = new JLabel("int r = 12");
		JLabel label8 = new JLabel("int b = 3");
		JLabel label9 = new JLabel("int v = r / b");
		...
		button5.addActionListener(new PlayButtonListener16());
		JButton button6 = new JButton("Next");
		button6.addActionListener(new PlayButtonListener17());
